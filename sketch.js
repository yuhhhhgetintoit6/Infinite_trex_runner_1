...
var diamondsImage, cashImage;
var diamondsGroup, cashGroup;
...
function spawnCash() {
  if(frameCount % 90 === 0) {
    var cash = createSprite(600,165,10,40);
...
function spawnDiamonds() {
  if(frameCount % 110 === 0) {
    var diamonds = createSprite(600,165,10,40);
